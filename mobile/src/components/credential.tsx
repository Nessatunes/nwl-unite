...
export function Credential({ data, onChangeAvatar, onExpandQRCode }:
  Props) {
  ...
  return (
    ...
    >
      ...
      />
      <View className="bg-black/20 self-stretchi items-center pb-6 border border-white/10 mx-3 rounded-2xl -mt-5">
        <ImageBackground
