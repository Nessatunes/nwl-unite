...
const EVENT_ID = "04ecc263-3af3-4aeb-b784-1b1cd2a1db75"
...
export default function register() {
    ...
    async function handleRegister() {
        try {
            ...
            if (registerResponse.data.attendeeId) {
                ...
                Alert.alert("Inscrição", "Incrição realiada com sucesso!", [
    ...
    return (
        <View className="flex-1 bg-green-500 items-center justify-center">
            ...
            <Image source={require("@/assets/ticket/logo.png")}
                className="h-16"
                resizeMode="contain" />
            ...
            <View className="w-full mt-12 gap-3">
                ...
                text-center mt-8 ">Já possui ingresso?</Link>
            </View>
        </View>
    )
}